...
export async function getStaticProps() {
  ...
  // {
  //   classes: {
  //     containerClasses: 'max-w-screen-xl mx-auto relative',
  //     olClasses: 'grid grid-cols-1 sm:grid-cols-12 gap-10',
  //     imageClasses: 'h-52'
  //   },
  //   widget: {
  ...
  //   classes: {
  //     containerClasses: 'max-w-screen-lg mx-auto relative',
  //     olClasses: 'grid grid-cols-3 gap-2 place-content-stretch',
  //     sectionTitleClasses: 'max-w-screen-lg mx-auto'
  //   },
  //   widget: {
  //     name: 'ListWidget',
  //     type: 'categories',
  ...
  const sections = [
    ...
    },
    {
      ...
      widget: {
        ...
        type: 'users',
        title: 'Authors List',
        desc: 'Most Popular Authors in order',
        count: 8,
        paginationStyle: 'loadmore',
        orderBy: 'id',
        order: 'desc',
