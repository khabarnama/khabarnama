    ...
    <>
      <Head>
        ...
        <link
          rel='stylesheet'
          id='cpcff_loader-css'
          href='https://admin.iap.af/wp-content/plugins/calculated-fields-form/css/loader.css?ver=1.1.4'
          type='text/css'
          media='all'
        />
        <link
          ...
          href='https://admin.iap.af/wp-content/plugins/calculated-fields-form/css/stylepublic.css?ver=1.1.4'
          type='text/css'
          media='all'
          property='stylesheet'
        />
...
export async function getStaticPaths() {
  const res = await fetch(`${process.env.NEXT_PUBLIC_SITE_URL}/pages?slug=afghantax`)
