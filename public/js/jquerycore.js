    ...
    (x.ui.focusable = function (t, e) {
      ...
      return 'area' === r
        ...
        : (/^(input|select|textarea|button|object)$/.test(r)
            ? (o = !t.disabled) && (s = x(t).closest('fieldset')[0]) && (o = !s.disabled)
            : (o = ('a' === r && t.href) || e),
          o &&
            x(t).is(':visible') &&
            (function (t) {
      ...
      flip: {
        left: function (t, e) {
          var i = e.within,
            ...
            r = -2 * e.offset[0]
          l < 0
            ? ((n = t.left + h + i + r + e.collisionWidth - o - n) < 0 || n < C(l)) &&
              (t.left += h + i + r)
            : 0 < a &&
              (0 < (s = t.left - e.collisionPosition.marginLeft + h + i + r - s) || C(s) < a) &&
              (t.left += h + i + r)
        },
        top: function (t, e) {
          var i = e.within,
            ...
            r = -2 * e.offset[1]
          l < 0
            ? ((n = t.top + h + i + r + e.collisionHeight - o - n) < 0 || n < C(l)) &&
              (t.top += h + i + r)
            : 0 < a &&
              (0 < (s = t.top - e.collisionPosition.marginTop + h + i + r - s) || C(s) < a) &&
              (t.top += h + i + r)
        }
      },
      flipfit: {
